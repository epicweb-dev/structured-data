...
5. **Tuples** - Fixed-length arrays with specific types at each position
6. **Array Methods** - Transforming data with `map`, `filter`, and `reduce`
7. **Enums** - Creating named constants for related values
